...
class NaviSettingsLabelsTest {
    ...
    fun videoLateralLabel_classifiesAroundCenter() {
        assertThat(NaviSettingsLabels.videoLateralLabel(0)).isEqualTo("0")
        assertThat(NaviSettingsLabels.videoLateralLabel(1)).isEqualTo("1")
        assertThat(NaviSettingsLabels.videoLateralLabel(49)).isEqualTo("49")
        assertThat(NaviSettingsLabels.videoLateralLabel(50)).isEqualTo("50")
        assertThat(NaviSettingsLabels.videoLateralLabel(51)).isEqualTo("51")
        assertThat(NaviSettingsLabels.videoLateralLabel(99)).isEqualTo("99")
        assertThat(NaviSettingsLabels.videoLateralLabel(100)).isEqualTo("100")
    }

    // 第3ラウンド新設: 映像の上下位置（0=上端/100=下端）。第4ラウンドで左右系と語彙・閾値を統一。
    @Test
    fun videoVerticalLabel_classifiesAroundCenter() {
        assertThat(NaviSettingsLabels.videoVerticalLabel(0)).isEqualTo("0")
        assertThat(NaviSettingsLabels.videoVerticalLabel(1)).isEqualTo("1")
        assertThat(NaviSettingsLabels.videoVerticalLabel(49)).isEqualTo("49")
        assertThat(NaviSettingsLabels.videoVerticalLabel(50)).isEqualTo("50")
        assertThat(NaviSettingsLabels.videoVerticalLabel(51)).isEqualTo("51")
        assertThat(NaviSettingsLabels.videoVerticalLabel(99)).isEqualTo("99")
        assertThat(NaviSettingsLabels.videoVerticalLabel(100)).isEqualTo("100")
    }
